...
// Properties:
//   startTime <Date> client's start time
...
//   server <Object> | <null> server instance
//   application <Application> instance of impress.Application
//   dynamicHandler <boolean> flag, true if client has been dispatched,
//       default: false
//   query <Object> collection of key and value pairs from url query
//   schema <string> if server's transport is `tls`,
//       is set to `https`, otherwise - `http`
//   method <string> the request method in lower case
...
//   timedOut <boolean> flag, is set to `true` if client hasn't been finished
...
//   chunks <Array> used to handle large requests receiving in chunks
//   ip <string> remote IP address
//   cookies <Object> received cookies
//   preparedCookies <string[]> prepared cookies to send
//   ipInt <number> | <undefined> converted remote IP address to number,
...
//   logged <boolean> user logged in flag, default: `false`
